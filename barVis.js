...
class BarVis {
    ...
    initVis(){
        ...
        vis.svg.append('g')
            ...
            .append('text')
            .text('Bar charts for top and bottom 10 states')
    ...
    wrangleData(){
        ...
        vis.topTenData = vis.stateInfo.filter( ( element, index ) => { return index < 10 } )
        console.log( "top ten: ", vis.topTenData )
    ...
    updateVis(){
        ...
        vis.xAxis.selectAll("path")
            .style("stroke", "white")

        vis.xAxis.selectAll("text")
            .style("stroke", "hotpink")

        vis.yAxis.selectAll("line")
            .style("stroke", "white")

        vis.yAxis.selectAll("path")
            .style("stroke", "white")
